...
export const TemplateGalleryCard = memo(function TemplateGalleryCard({
  ...
  return (
    <div
      data-gallery-item-id={template.id}
        ...
        <div className="flex min-h-[92px] flex-1 flex-col justify-between px-1 pt-3">
          ...
          <div className="mt-2 flex items-center justify-between gap-2">
            ...
            {isDefaultTemplate ? (
              <Badge
                variant="outline"
                className="h-6 rounded-md border-border/80 bg-muted px-2 text-[11px] font-medium text-muted-foreground"
              >

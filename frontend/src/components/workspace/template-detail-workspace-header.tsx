...
import { TemplateHeading } from "@/components/templates/template-heading";
    ...
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        >
          ...
          <span className="hidden lg:inline">{messages.backToTemplates}</span>
        </Button>
        {template ? (
          <TemplateHeading
            messages={getTemplateEditorMessages(locale, messages)}
            template={template}

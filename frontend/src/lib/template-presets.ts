import { builtinTemplatePresets as generatedBuiltinTemplatePresets } from "@/lib/template-presets.generated";
import type {
...
type BuiltinTemplateLayout = Omit<Readonly<ResumeTemplateLayout>, "images"> & {
